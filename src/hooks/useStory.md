...
This custom hook maintains the story state. It has functionality to
- update a section of our story given new text
- Replace current story data

Below shown the data from MD file
